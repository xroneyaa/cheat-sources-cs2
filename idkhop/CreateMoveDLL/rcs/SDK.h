...
// CS2 offsets. synced with local dump/output generated on 2026-05-29.
...
namespace offsets {
    // client.dll
    constexpr uintptr_t dwEntityList            = 0x24E5590; // CGameEntitySystem* (vtable-having obj)
    constexpr uintptr_t dwLocalPlayerController = 0x231E700; // CBasePlayerController* array (slot 0 = local)
    constexpr uintptr_t dwLocalPlayerPawn       = 0x233F698; // C_CSPlayerPawn* direct fallback
    ...
    constexpr uintptr_t dwEntityPageTable = 0x21B0A60;
    ...
    constexpr uintptr_t m_angEyeAngles         = 0x3320; // QAngle (pitch=[0], yaw=[1], roll=[2])
    constexpr uintptr_t m_angEyeAnglesVelocity = 0x33F0; // QAngle
    ...
    constexpr uintptr_t m_flStamina            = 0x69C; // float [0, ~100]
    constexpr uintptr_t m_nLastJumpTick        = 0x708; // GameTick_t (int32)
    constexpr uintptr_t m_flVelMulAtJumpStart  = 0x6B0; // float
    constexpr uintptr_t m_ModernJump           = 0x6D0; // CCSPlayerModernJump
    ...
    constexpr uintptr_t dwForceJump        = 0x2063FA0;
